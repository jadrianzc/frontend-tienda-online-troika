	...
	return (
		<Router>
			<Switch>
				...
				<PrivateRoute hasRole="admin" path="/Admin/Pedidos" exact component={AdminPedidos} />
				...
				<>
					...
					<PrivateRoute path="/HistorialTransacciones" exact component={HistorialTransacciones} />
