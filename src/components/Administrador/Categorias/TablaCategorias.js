...
function TablaCategorias(stado) {
	...
	const bodyElimi = (
		<div className="ModalRegistro">
			...
			<p id="simple-modal-description">¿Esta seguro de eliminar la categoría?</p>
			<input type="button" className="btnPwd btnPwdAcep" value="Continuar" onClick={EliminaCategoria} />
			<input
				type="button"
	...
	const bodyEdit = (
		<div className="ModalRegistro">
			...
			<input type="button" className="btnPwd btnPwdAcep" value="Actualizar" onClick={AcrualizaCategori} />
			<input
				type="button"
				className=" btnPwd btnPwdCan"
				value="Cancelar"
		...
		<div style={{ height: 300, width: '100%' }}>
			<Grid container alignItems="center">
				<from style={{ display: 'contents' }}>
					<label>Nombre:</label>
					<input type="text" value={buscar} onChange={handleChangeBusqueda}></input>
