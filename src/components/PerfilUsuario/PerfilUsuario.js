...
const PerfilUsuario = () => {
	...
	const BtnPwd = () => {
		...
		} else if (pwd === false && pwd2 === false && datosPwd.contraseña_usuario && datosPwd.conf_contraseña) {
			setPwdActual(false);
			setErrorPwdActual('');
			setOpenModal(true);
		}
	...
	const body = (
		<div className="ModalRegistro">
			...
			<p id="simple-modal-description">¿Esta seguro de cambiar la contraseña?</p>
			<input type="button" className="btnPwd btnPwdAcep" value="Continuar" onClick={CambiaPwd} />
			<input
				type="button"
		...
		<Container className="container-user">
			<Grid container className="grid-container-user">
				...
				<Grid item className="grid-item-perfil">
					...
					<form onSubmit={handleSubmit}>
						<Grid container className="grid-item-col">
							<Grid item className="grid-item-img" xs={12} sm={12} md={6} lg={4}>
								<img src={datos.imgurl} alt="Imagen-Usuario" />
							</Grid>
							<Grid item className="grid-item-data" xs={12} sm={12} md={6} lg={4}>
							...
							<Grid item className="grid-item-data grid-item-data-emails" xs={12} sm={12} md={6} lg={4}>
				...
				<Grid item className="grid-item-seguridad">
					...
					<Grid container className="grid-item-col">
						<Grid item className="grid-item-data grid-item-margin" xs={12} sm={12} md={6}>
						...
						<Grid item className="grid-item-data" xs={12} sm={12} md={6}>
							<Grid container className="Btn-grid-container-data2 Btn-data" justifyContent="center" alignItems="center">
