...
const Pago = () => {
	return (
		<Container className="container-user container-pago">
			...
			<Grid container className="grid-container-user grid-item-pago-info" alignItems="flex-start">
				<Grid item className="grid-item-metodoPago grid-item-pago-info-p">
					<FormGroup row className="grid-item-metodoPago-form">
						<p className="grid-item-metodoPago-form-p">Información enviada correctamente a su email.</p>
					</FormGroup>
				</Grid>
